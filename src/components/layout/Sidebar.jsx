...
export const Sidebar = () => {
  ...
  const filteredMachines = Object.values(MACHINE_TYPES).filter(m => 
    m.name.toLowerCase().includes(searchTerm.toLowerCase()) || 
    m.tag.toLowerCase().includes(searchTerm.toLowerCase())
  );

  return (
    <div className={`relative h-full transition-all duration-300 z-40 ${isSidebarOpen ? 'w-80' : 'w-16'}`}>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-1.5 mt-1">
                        ...
                        <span className="text-[10px] text-white/30 uppercase tracking-tighter font-semibold">Available</span>
                      </div>
                    </div>
                  </div>
